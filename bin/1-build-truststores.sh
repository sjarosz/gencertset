...
[ ! -d $certtools_home/target  ] && mkdir -p $certtools_home/target/public/authority
[ ! -d $certtools_home/target/truststores  ] && mkdir -p $certtools_home/target/truststores
...
mv $certtools_home/target/trust.* $certtools_home/target/truststores
cp -rf $certtools_home/staging/authority/authority.crt $certtools_home/target/public/authority
